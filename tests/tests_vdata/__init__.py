...
expr_data_simple = np.array([[10, 11, 12], [20, 21, 22], [30, 31, 32], [40, 41, 42], [50, 51, 52], [60, 61, 62]])
...
expr_data_medium = {
    ...
    "unspliced": pd.DataFrame(
        np.array(
            [[1.0, 1.1, 1.2], [2.0, 2.1, 2.2], [3.0, 3.1, 3.2], [4.0, 4.1, 4.2], [5.0, 5.1, 5.2], [6.0, 6.1, 6.2]]
        ),
        columns=["g1", "g2", "g3"],
    ),
}
...
expr_data_complex = {
    "spliced": vdata.TemporalDataFrame(
        {"g1": [10, 20, 30, 40, 50, 60], "g2": [11, 21, 31, 41, 51, 61], "g3": [12, 22, 32, 42, 52, 62]},
        timepoints=["0h", "0h", "0h", "0h", "5h", "5h"],
        index=obs_index_data,
    ),
    "unspliced": vdata.TemporalDataFrame(
        {
