...
AnyNDArrayLike_IF = Union[npt.NDArray[np.int_ | np.float_],
                          ch.H5Array[np.int_ | np.float_],
                          NDArrayView[np.int_ | np.float_]]

NDArray_IFS = npt.NDArray[np.int_ | np.float_ | np.str_]
NDArrayLike_IFS = Union[npt.NDArray[np.int_ | np.float_ | np.str_], 
                        ch.H5Array[np.int_ | np.float_ | np.str_]]
AnyNDArrayLike_IFS = Union[npt.NDArray[np.int_ | np.float_ | np.str_], 
                           ch.H5Array[np.int_ | np.float_ | np.str_], 
